<template>
  <el-row :gutter="40" class="panel-group">
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('sensor')">
        <div class="card-panel-icon-wrapper icon-people">
          <svg-icon icon-class="tree" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">传感器个数</div>
          <count-to
            :start-val="0"
            :end-val="41"
            :duration="2600"
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('alarm')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">异常报警数</div>
          <count-to
            :start-val="0"
            :end-val="23"
            :duration="3000"
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('solved')">
        <div class="card-panel-icon-wrapper icon-money">
          <svg-icon icon-class="dashboard" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">当前异常值(%)</div>
          <count-to
            :start-val="0"
            :end-val="6"
            :duration="3200"
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('user')">
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">异常阈值(%)</div>
          <count-to
            :start-val="0"
            :end-val="20"
            :duration="3600"
